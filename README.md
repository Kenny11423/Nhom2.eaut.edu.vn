...
Cấu trúc chính
    ...
    docs/tuan1/mo-ta-chuc-nang.md
    docs/tuan1/mockup-ui.svg
    docs/tuan2/thiet-ke-co-so-du-lieu.md
    docs/tuan2/phan-chia-cong-viec-3-nguoi.md
    docs/tuan3/phan-chia-cong-viec-3-nguoi.md
    app.py
...
Kết quả tuần 3
    ...
    Phân chia công việc tuần 3 cho 3 thành viên tại docs/tuan3/phan-chia-cong-viec-3-nguoi.md

Thư viện cần cài

Tất cả thư viện ngoài thư viện chuẩn đã được khai báo trong requirements.txt:
